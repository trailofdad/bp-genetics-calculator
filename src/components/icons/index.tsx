import { createFaIcon } from './createFaIcon'
...
export const ArrowDownWideShortIcon   = createFaIcon('arrow-down-wide-short')
export const ArrowDownShortWideIcon   = createFaIcon('arrow-down-short-wide')
...
export const CopyIcon          = createFaIcon('copy')
export const BookmarkIcon      = createFaIcon('bookmark')
export const ArrowRotateLeftIcon = createFaIcon('arrow-rotate-left')
export const ArrowUpRightFromSquareIcon = createFaIcon('arrow-up-right-from-square')
export const PercentIcon       = createFaIcon('percent')
export const ArrowDownAZIcon   = createFaIcon('arrow-down-a-z')
export const ArrowDownZAIcon         = createFaIcon('arrow-down-z-a')
export const ArrowDownArrowUpIcon    = createFaIcon('arrow-down-arrow-up')
export const EyeIcon           = createFaIcon('eye')
export const EyeSlashIcon      = createFaIcon('eye-slash')
export const ListIcon          = createFaIcon('list')

// ── Indicators ────────────────────────────────────────────────────────────────
export const TriangleExclamationIcon = createFaIcon('triangle-exclamation')
export const CircleInfoIcon   = createFaIcon('circle-info')
export const StarIcon         = createFaIcon('star')
export const BullseyeIcon     = createFaIcon('bullseye')
export const LightbulbIcon    = createFaIcon('lightbulb')
export const SeedlingIcon     = createFaIcon('seedling')
export const DatabaseIcon     = createFaIcon('database')

// ── Sex ───────────────────────────────────────────────────────────────────────
export const MarsIcon       = createFaIcon('mars')
export const VenusIcon      = createFaIcon('venus')
