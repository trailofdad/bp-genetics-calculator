...
function AnimalCard({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-white/5 bg-[#1a2035] p-4">
      {/* Header */}
      ...
      <div className="flex gap-2 pt-1">
        {onLoad1 && (
          <button
            onClick={onLoad1}
            className="flex-1 rounded-lg border border-white/5 bg-white/5 px-3 py-1.5 text-xs text-slate-300 transition-colors hover:bg-white/10 hover:text-white"
          >
            → Sire
          </button>
        )}
...
export function ImportModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
      <div className="flex max-h-[90vh] w-full max-w-2xl flex-col rounded-2xl border border-white/10 bg-[#161b27] shadow-2xl">
        {/* Header */}
        ...
        <div className="flex flex-shrink-0 flex-col gap-3 border-b border-white/5 px-6 py-4">
          <textarea
            ...
            rows={4}
            className="w-full resize-none rounded-lg border border-white/10 bg-[#0d1117] px-3 py-2 font-mono text-xs text-slate-300 placeholder:text-slate-600 focus:ring-1 focus:ring-indigo-500/50 focus:outline-none"
          />
        ...
        {/* Footer */}
        {animals.length > 0 && (
          <div className="flex flex-shrink-0 items-center justify-between border-t border-white/5 px-6 py-3">
            <span className="text-xs text-slate-500">
